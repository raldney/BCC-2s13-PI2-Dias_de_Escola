...
ALLEGRO_BITMAP *sairMenu,*charSET,*personagemCHAR[12], *iniciarMenu,*continuarMenu,*fundoDisplay,*historiaImagem,*personagemHistoria,*peterImagem,*sabrinaImagem,*selectCHAR;
...
bool sair = false,celula = false,tabela=false,cadeia=false,bola=false,fotossintese=false,escolha = false,concluido = false,responder=false, keys[]={false,false,false,false,false};
char sexo = 'c', lerMapa,resposta[17];
int iniciarOption = 1,sairOption= 0,continuarOption= 0,peterOption=1,sabrinaOption=0,sairClick=0,x = 64,y = 64,i,j,mapa = -1,colisao=-1,top=0,down=0,right=0,left=0;
